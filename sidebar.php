...
<aside class="main-sidebar sidebar-light-primary elevation-4" style="background-color: #ecf0f1; color: #2c3e50;">
    <!-- Tambahkan konten sidebar AdminLTE di sini -->
    <a href="index.php?page=dashboard" class="brand-link">
        <center>
            <span class="brand-text font-weight-light">
                <img src="img/sekolahku.png" alt="" style="width:150px;">
            </span>
            &emsp;&emsp;<h3 style="color: #2c3e50;">SEKOLAHKU</h3>
        </center>
    </a>
    <div class="sidebar">
        <ul class="nav nav-pills nav-sidebar flex-column nowrap" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
                <a href="index.php?page=dashboard" class="nav-link <?php echo isPageActive('dashboard'); ?>" style="color: #2c3e50;">
                    <i class="fa fa-tachometer-alt nav-icon" style="color: #2c3e50;"></i>
                    <p>Home</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="datasiswa.php?page=datasiswa" class="nav-link <?php echo isPageActive('datasiswa'); ?>" style="color: #2c3e50;">
                    <i class="fa fa-book nav-icon" style="color: #2c3e50;"></i>
                    <p>Data Siswa</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="dataguru.php?page=dataguru" class="nav-link <?php echo isPageActive('dataguru'); ?>" style="color: #2c3e50;">
                    <i class="fa fa-book nav-icon" style="color: #2c3e50;"></i>
                    <p>Data Guru</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="rekapdatasiswa.php?page=rekapdatasiswa" class="nav-link <?php echo isPageActive('rekapdatasiswa'); ?>" style="color: #2c3e50;">
                    <i class="fa fa-list nav-icon" style="color: #2c3e50;"></i>
                    <p>Rekap Data siswa</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="rekapdataguru.php?page=rekapdataguru" class="nav-link <?php echo isPageActive('rekapdataguru'); ?>" style="color: #2c3e50;">
                    <i class="fa fa-list nav-icon" style="color: #2c3e50;"></i>
                    <p>Rekap Data Guru</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="#" class="nav-link logout-link" style="color: #2c3e50;">
                    <i class="fas fa-sign-out-alt nav-icon" style="color: #2c3e50;"></i>
                    <p>Logout</p>
                </a>
            </li>
        </ul>
