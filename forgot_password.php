...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT userid, username, fullname FROM db_sekolahku.users WHERE username = ? OR fullname = ?";
...
<head>
    ...
    <link rel="icon" href="img/sekolahku.png" type="image/png">
    <style>
...
<body>
    <div class="content">
        ...
        <div class="text">Forgot Password <span style="color:green">SEKOLAHKU</span></div>
