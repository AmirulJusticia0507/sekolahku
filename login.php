...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT userid, username, password, fullname, status FROM db_bmt_beningsuci.users WHERE username = ? OR fullname = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            $updateQuery = "UPDATE db_sekolahku.users SET login_date = ? WHERE userid = ?";
...
<body>
    <div class="content">
        <div class="col-md-6" align="center">
            <img src="img/sekolahku.png" alt="Image" class="img-fluid" style="width:100%">
        </div>
        <div class="text">Login <span style="color:green">SEKOLAHKU</span></div>
