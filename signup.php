...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO db_sekolahku.users (Username, PASSWORD, FullName, created_at, status) VALUES (?, ?, ?, ?, ?)";
...
<body>
    <div class="content">
        ...
        <div class="text">Signup <span style="color:green">SEKOLAHKU</span></div>
